...
curl -L $(curl -s https://api.github.com/repos/aarron-lee/SDH-PauseGames/releases/latest | grep "browser_download_url" | cut -d '"' -f 4) -o $HOME/SDH-PauseGames.zip
sudo 7z x ./SDH-PauseGames.zip  -o$HOME/homebrew/plugins
